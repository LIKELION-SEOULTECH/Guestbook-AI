...
ori_t = pd.read_excel('/Users/jogeonhui/Documents/LikeLion/1~2week_development_session/sentimental_chat/Training_221115_add/원천데이터/감성대화말뭉치(최종데이터)_Training.xlsx')
ori_v = pd.read_excel('/Users/jogeonhui/Documents/LikeLion/1~2week_development_session/sentimental_chat/Validation_221115_add/원천데이터/감성대화말뭉치(최종데이터)_Validation.xlsx')
...
print(chatbot["Emotion"].value_counts())
...
print(f"ONNX 파일로 저장 완료: {onnx_path}")